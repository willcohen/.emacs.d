...
#+AUTHOR: Will Cohen
#+OPTIONS: toc:4 h:4
# Time-stamp: <2016-12-28 15:53:30 wcohen>
...
**** Installing a version of python using these tools

=pyenv install 3.6.0=
=pyenv global 3.6.0=

See [[https://github.com/yyuu/pyenv-virtualenvwrapper][github]].

**** Configuration

Be sure to install =jedi=, =flake8=, =isort=, and =yapf=.
...
Disable electric-indent-mode because of bugs. From [[http://emacs.stackexchange.com/questions/14039/list-indentation-problem-in-rst-mode][stackexchange]].
...
From [[http://jblevins.org/log/emacs-omnifocus][jblevins.org]]:
